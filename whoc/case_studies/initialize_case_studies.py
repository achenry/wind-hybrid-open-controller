...
case_studies = {
    ...
    "baseline_controllers_informer_forecasters_awaken_tmp": {
...
case_families = [
    "baseline_controllers", "solver_type", # 0, 1
     ...
     "baseline_controllers_informer_forecasters_awaken_tmp", "baseline_controllers_autoformer_forecasters_awaken", # 15, 16
