...
case_studies = {
    ...
    "yaw_offset_study": {"controller_class": {"group": 1, "vals": ["MPC", "MPC", "MPC", "MPC", "MPC", "LookupBasedWakeSteeringController", "MPC", "MPC"]},
                          "case_names": {"group": 1, "vals":["Perfect_3turb", "Persistent_3turb", f"StochasticIntervalRectangular_1_3turb", f"StochasticIntervalRectangular_11_3turb", f"StochasticIntervalElliptical_11_3turb", 
                                                             f"LUT_3turb", f"StochasticSample_25_3turb", f"StochasticSample_100_3turb"]},
                          "wind_preview_type": {"group": 1, "vals": ["perfect", "persistent"] + ["stochastic_interval_rectangular"] * 2 + ["stochastic_interval_elliptical"] + ["none"] + ["stochastic_sample"] * 2},
                           "n_wind_preview_samples": {"group": 1, "vals": [1, 1, 1, 11, 11, 1, 25, 100]},
                           "floris_input_file": {"group": 0, "vals": [os.path.join(os.path.dirname(whoc_file), 
