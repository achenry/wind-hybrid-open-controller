...
# --- Validation Settings for 360s Horizon ---
...
# Usage: sbatch /user/taed7566/Forecasting/wind-hybrid-open-controller/whoc/wind_forecast/run_scripts/run_wind_forecasting_STORM_360_fixed.sh